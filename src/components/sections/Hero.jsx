...
const Hero = () => {
  return (
    <div className="relative overflow-hidden">
      <div className="absolute right-0 top-0 z-20 hidden h-full w-2/5 translate-x-16 bg-[radial-gradient(ellipse_at_right,_rgba(255,0,0,0.6)_0%,_rgba(255,255,255,0)_70%)] md:block"></div>
      ...
      <div className="mx-auto mb-20 mt-8 flex max-w-[1050px] items-center space-x-10 sm:mb-44 sm:mt-32 md:space-x-20 lg:mb-52 lg:mt-32">
        <div className="mx-10 flex flex-col items-center sm:items-start">
          ...
          <h2 className="text-xl font-thin tracking-widest text-[#909090] sm:text-2xl lg:mt-1 lg:text-4xl">
            Engineering Student
          </h2>
          <img
          ...
          <p className="sm: mx-4 my-8 text-center text-sm font-light leading-6 tracking-wider text-[#929292] sm:mx-0 sm:text-left sm:leading-7">
        ...
        <div className="flex:none relative hidden w-1/2 sm:block">
          <img className="relative z-10" src={heroPhoto} alt="Hero Photo" />
        </div>
      </div>
    </div>
  );
