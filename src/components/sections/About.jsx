...
const About = () => {
  ...
  return (
    ...
    >
      {/* Image 1 and Grad 1 */}
      <div className="relative mx-10 hidden transform rounded-xl bg-gradient-to-br from-orange-500 to-[#FF0000] to-80% p-1 transition-transform duration-500 hover:scale-105 sm:flex">
        <img
      ...
      >
        {/* Image 2 and Grad 2 */}
        <div className="relative mx-10 mt-10 hidden transform rounded-xl bg-gradient-to-br from-orange-500 to-[#FF0000] to-80% p-1 transition-transform duration-500 hover:scale-105 sm:flex">
          <img
            className="relative z-10 rounded-xl sm:max-w-40 md:max-w-60 lg:max-w-96"
            src={aboutPhoto2}
      ...
      <div className="mb-28 ml-10 mr-10 flex translate-y-10 flex-col items-start justify-center sm:absolute sm:ml-[245px] sm:mr-5 md:ml-[325px] lg:ml-[485px]">
        <h3 className="mb-7 bg-gradient-to-r from-orange-500 to-[#FF0000] to-80% bg-clip-text text-3xl font-light tracking-wider text-transparent md:text-4xl">
          About Me
        </h3>
        ...
        <motion.button
          className="rounded-xl bg-gradient-to-r from-orange-500 to-[#FF0000] to-80% p-[1px]"
